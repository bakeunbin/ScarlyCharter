...
CREATE TABLE LOCATION (
	...
	Type			VARCHAR (30)	NOT NULL, --River, Lake, Inshore, Offshore
	Availability	BIT,
);
...
ALTER TABLE SCHEDULE ADD FOREIGN KEY (Guide_Name) REFERENCES GUIDE (Guide_Name) ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE FISH ADD FOREIGN KEY (Location) REFERENCES LOCATION (Location_ID) ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE FISH ADD FOREIGN KEY (Region) REFERENCES REGION (Region_ID) ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE FISH ADD FOREIGN KEY (Season) REFERENCES SEASON (Season_ID) ON DELETE CASCADE ON UPDATE CASCADE;
...
INSERT INTO LOCATION VALUES (3, 2, 'River', 1)
INSERT INTO LOCATION VALUES (3, 4, 'Offshore', 0)
INSERT INTO LOCATION VALUES (4, 3, 'Lake', 0) 
...
INSERT INTO SEASON VALUES (4, 'Winter') 
...
INSERT INTO SCHEDULE VALUES ('2021-03-04', 'John J Cod', 0, 1, 0, 0)
INSERT INTO SCHEDULE VALUES ('2021-07-06', 'Jill M Red', 1, 0, 1, 1)
INSERT INTO SCHEDULE VALUES ('2021-09-10', 'Gary Y James', 0, 1, 0, 0)
