        ...
        protected override void OnModelCreating (ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<BookedTrip> (entity =>
            {
                entity.HasKey (e => e.TripId)
                    .HasName ("PK__BOOKED_T__685272BEA1D0DEE7");
                ...
                entity.HasOne (d => d.Client)
                    ...
                    .HasConstraintName ("FK__BOOKED_TR__Clien__3A81B327");

                entity.HasOne (d => d.Guide)
                    .WithMany (p => p.BookedTrips)
                    .HasForeignKey (d => d.GuideId)
                    .HasConstraintName ("FK__BOOKED_TR__Guide__3B75D760");

                entity.HasOne (d => d.Schedule)
                    .WithMany (p => p.BookedTrips)
                    .HasForeignKey (d => d.ScheduleId)
                    .HasConstraintName ("FK__BOOKED_TR__Sched__3C69FB99");
            });
            ...
            modelBuilder.Entity<Fish> (entity =>
            {
                ...
                entity.HasOne (d => d.Region)
                    ...
                    .HasConstraintName ("FK__FISH__Region_ID__300424B4");

                entity.HasOne (d => d.Season)
                    .WithMany (p => p.Fish)
                    .HasForeignKey (d => d.SeasonId)
                    .OnDelete (DeleteBehavior.SetNull)
                    .HasConstraintName ("FK__FISH__Season_ID__30F848ED");
            });
            ...
            modelBuilder.Entity<Guide> (entity =>
            {
                ...
                entity.HasOne (d => d.Region)
                    .WithMany (p => p.Guides)
                    .HasForeignKey (d => d.RegionId)
                    .HasConstraintName ("FK__GUIDE__Region_ID__35BCFE0A");

                entity.HasOne (d => d.Season)
                    .WithMany (p => p.Guides)
                    .HasForeignKey (d => d.SeasonId)
                    .OnDelete (DeleteBehavior.SetNull)
                    .HasConstraintName ("FK__GUIDE__Season_ID__36B12243");
            });
            ...
            modelBuilder.Entity<Location> (entity =>
            {
                ...
                entity.HasOne (d => d.Region)
                    ...
                    .HasForeignKey (d => d.RegionId)
                    .HasConstraintName ("FK__LOCATION___Regio__2D27B809");
            });
            ...
            modelBuilder.Entity<Region> (entity =>
            {
                ...
                entity.HasOne (d => d.Season)
                    ...
                    .HasForeignKey (d => d.SeasonId)
                    .HasConstraintName ("FK__REGION__Season_I__29572725");
            });
